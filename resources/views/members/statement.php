...
<div class="section">
    ...
    <div class="info-grid">
        ...
        <div class="info-item"><label>Full Name</label><span><?= htmlspecialchars(trim(($member['first_name'] ?? '') . ' ' . ($member['last_name'] ?? '')) ?: '—') ?></span></div>
...
<div class="kpi-row">
    ...
    <div class="kpi"><div class="kpi-val"><?= $member['total_loans'] ?? 0 ?></div><div class="kpi-lbl">Total Loans</div></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right <?= ($l['balance_outstanding'] ?? 0) > 0 ? 'debit' : '' ?>"><?= Format::currency((float)($l['balance_outstanding'] ?? 0)) ?></td>
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($transactions as $t):
                    $isCredit = in_array($t['txn_type'] ?? '', ['deposit','loan_repayment','membership_fee','interest']);
