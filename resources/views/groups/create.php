...
<div class="max-w-2xl mx-auto">
  <div class="flex items-center justify-between mb-5">
    ...
    <a href="<?= APP_URL ?>/groups" class="btn btn-secondary btn-sm">
  ...
  <div class="card">
    <div class="card-body">
      <form id="createGroupForm" enctype="multipart/form-data">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" id="name" name="name" class="form-control"
                     placeholder="e.g. Kampala Women's SACCO" required>
            </div>
            <div>
              <label class="form-label" for="description">Description</label>
              <textarea id="description" name="description" rows="2" class="form-control"
                        placeholder="Brief description of the group's purpose and objectives…"></textarea>
            </div>
            <div>
              <label class="form-label" for="meeting_schedule">Meeting Schedule</label>
              <input type="text" id="meeting_schedule" name="meeting_schedule" class="form-control"
        ...
        <!-- Leadership -->
        <div class="mb-5">
          <div class="mb-3" style="font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:var(--green-mid)">
  ...
  try {
    ...
    if (data.success) {
      ...
      if (data.data && data.data.redirect) {
        ...
        setTimeout(() => { window.location.href = '<?= APP_URL ?>/groups'; }, 800);
      }
    } else {
